...
![Задание деклараций](image/2.png){#fig:001 width=70%}
...
![Модель простого протокола передачи данных](image/7.png){#fig:005 width=70%}

![Запуск модели простого протокола передачи данных](image/8.png){#fig:006 width=70%}
...
- 13341 состояний и 206461 переходов между ними.(рис. [-@fig:007])
...
- Указаны границы в виде мультимножеств.(рис. [-@fig:008])
- Маркировка home для всех состояний (в любую позицию можно попасть из любой другой маркировки).
- Маркировка dead равная 4675 [9999,9998,9997,9996,9995,...] -- это состояния, в которых нет включенных переходов.(рис. [-@fig:009])
