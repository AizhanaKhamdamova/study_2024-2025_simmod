...
![Дерево достижимости](image/3.png){#fig:002 width=70%}
...
Реализуем описанную ранее модель в CPN Tools.(рис. [-@fig:007]) С помощью контекстного меню создаем новую сеть, далее нам понадобятся 6 позиций и 6 блоков переходов, затем их нужно соединить, а также задать параметры и начальные значения. Получаем готовую модель (рис. [-@fig:003]).

![Модель задачи в CPN Tools](image/6.png){#fig:003 width=70%}
