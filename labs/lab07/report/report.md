...
Реализовать модель массового обсулуживания типа M|M|1 в xcos.
...
![Модель $M|M|1|\infty$ в xcos](image/6.png){#fig:004 width=70%}
...
![Динамика размера очереди](image/8.png){#fig:005 width=70%}

![Поступление и обработка заявок](image/7.png){#fig:006 width=70%}
