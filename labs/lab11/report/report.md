...
![Граф процесса обработки заявок на сервере системы](image/4.png){#fig:003 width=70%}
...
![Задание деклараций системы](image/11.png){#fig:004 width=70%}
...
- у позиции `Completed` множество цветов фишек — `Job`.(рис. [-@fig:020])

![Параметры элементов основного графа системы обработки заявок в очереди](image/7.png){#fig:005 width=70%}
...
![Параметры элементов генератора заявок системы](image/5.png){#fig:006 width=70%}
...
заявка считается обслуженной;(рис. [-@fig:021])
...
![Параметры элементов обработчика заявок системы](image/6.png){#fig:007 width=70%}
...
![Функция Predicate монитора Ostanovka](image/17.png){#fig:008 width=70%}
...
![Функция Observer монитора Queue Delay](image/18.png){#fig:009 width=70%}
...
очереди, во второй — счётчик, в третьей — шаг, в четвёртой — время. (рис. [-@fig:018])

![Файл Queue_Delay.log](image/21.png){#fig:010 width=70%}

![Файл Queue_Delay.log](image/23.png){#fig:018 width=70%}
...
![График изменения задержки в очереди](image/22.png){#fig:011 width=70%}
...
![Содержимое Queue_Delay_Real.log](image/23.png){#fig:013 width=70%}
...
![Содержимое Long_Delay_Time.log](image/24.png){#fig:016 width=70%}
...
![Периоды времени, когда значения задержки в очереди превышали заданное значение](image/25.png){#fig:017 width=70%}
